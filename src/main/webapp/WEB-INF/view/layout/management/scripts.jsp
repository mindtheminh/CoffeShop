...
<script src="${cPath}/assets/startbootstrap-sb-admin/js/scripts.js"></script>
...
<script src="${cPath}/assets/demo/chart-area-demo.js"></script>
<script src="${cPath}/assets/demo/chart-bar-demo.js"></script>
<script src="${cPath}/assets/demo/chart-pie-demo.js"></script>

<!-- Global JS (if exists) -->
<script src="${cPath}/assets/js/global.js"></script>
...
window.alert = function(message) {
    showNotification(message, 'info', 'Thông báo');
};
...
window.confirm = function(message) {
    ...
    // Note: This won't work synchronously like native confirm
    // We'll need to use showConfirm with callbacks instead
    return result;
};
</script>
