...
<%
    ...
    request.setAttribute("pageTitle", "Chỉnh sửa cấu hình - Yen Coffee");
%>
            ...
            <div class="container-fluid" style="background-color:#f8f9fc;min-height:100vh;">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">Cập nhật thông tin chi tiết cấu hình hệ thống</p>
                    </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex align-items-center justify-content-between"
                        ...
                        <span class="badge bg-light text-primary text-uppercase">Chỉnh sửa</span>
                    </div>
                    <div class="card-body" style="padding: 2rem 2.5rem;">
                        ...
                        <c:if test="${not empty successMessage}">
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                <strong>Cập nhật cấu hình thành công!</strong> ${successMessage}
                        ...
                        <c:if test="${setting != null}">
                        <form method="post" action="${pageContext.request.contextPath}/setting-edit" id="settingForm" novalidate>
                            ...
                            <div class="row g-4">
                                <div class="col-lg-3 text-center d-flex flex-column align-items-center justify-content-start">
                                    ...
                                    <div class="info-value"><strong>#${setting.settingId}</strong></div>
                                </div>
                                ...
                                <div class="col-lg-9">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control ${not empty fieldErrors['name'] ? 'is-invalid' : ''}"
                                                   ...
                                                   value="${setting.name != null ? setting.name : ''}" placeholder="Nhập tên cấu hình">
                                            ...
                                            <input type="text" class="form-control ${not empty fieldErrors['value'] ? 'is-invalid' : ''}"
                                                   ...
                                                   value="${setting.value != null ? setting.value : ''}" placeholder="Nhập giá trị">
                                            ...
                                            <select class="form-select ${not empty fieldErrors['datatype'] ? 'is-invalid' : ''}" name="datatype" id="datatype" required>
                                                ...
                                                <option value="Email" ${setting.datatype == 'Email' ? 'selected' : ''}>Email</option>
                                                <option value="Currency" ${setting.datatype == 'Currency' ? 'selected' : ''}>Currency</option>
                                                <option value="Percentage" ${setting.datatype == 'Percentage' ? 'selected' : ''}>Percentage</option>
                                                <option value="Time" ${setting.datatype == 'Time' ? 'selected' : ''}>Time</option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select ${not empty fieldErrors['category'] ? 'is-invalid' : ''}" name="category" id="category" required>
                                                ...
                                                <option value="General" ${setting.category == 'General' ? 'selected' : ''}>Chung</option>
                                                <option value="Notification" ${setting.category == 'Notification' ? 'selected' : ''}>Thông báo</option>
                                                <option value="Delivery" ${setting.category == 'Delivery' ? 'selected' : ''}>Giao hàng</option>
                                                <option value="Finance" ${setting.category == 'Finance' ? 'selected' : ''}>Tài chính</option>
                                                <option value="Operation" ${setting.category == 'Operation' ? 'selected' : ''}>Vận hành</option>
                                                <option value="Reservation" ${setting.category == 'Reservation' ? 'selected' : ''}>Đặt chỗ</option>
                                            </select>
                                            ...
                                            <div class="d-flex gap-3 flex-wrap">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="status" id="statusActive" value="Active" ${setting.status == 'Active' || setting.status == 'ACTIVE' ? 'checked' : ''} required>
                                                    <label class="form-check-label" for="statusActive"><i class="fas fa-check-circle text-success me-1"></i>Hoạt động</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="status" id="statusInactive" value="Inactive" ${setting.status == 'Inactive' || setting.status == 'INACTIVE' ? 'checked' : ''}>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-6">
                                            ...
                                            <textarea class="form-control ${not empty fieldErrors['description'] ? 'is-invalid' : ''}" name="description" id="description" rows="4">${setting.description != null ? setting.description : ''}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea class="form-control" name="note" id="note" rows="4">${setting.note != null ? setting.note : ''}</textarea>
                                        </div>
                                    </div>

                                    <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                                        <a href="${pageContext.request.contextPath}/setting-detail?id=${setting.settingId}" class="btn btn-outline-secondary">
